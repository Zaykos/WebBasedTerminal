# A docker dashboard with a web based terminal for containers 
...
This project was principally used as a platform for consultants to test security solutions locally, and then suggest a few solutions to their clients.
